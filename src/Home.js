    ...
    <div className="secondBox">
        <Card
          ...
          <Card
            ...
            link="/practice-areas/criminal-law"
            description="Call or send a message with the contact form below for a free initial consultation! Do not hesistate to send an email or text, at any time. The contact page in this website contains more information about this."/>
    </div>
